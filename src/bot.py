    ...
    while True:
        ...
        for rota in ROTAS:
            ...
            for oferta in ofertas:
                ...
                # Salva no dashboard mesmo sem notificar
                oferta["grupo"] = grupo
                todas_ofertas.append(oferta)

                # Filtra preço 0 (sem preço definido) — só salva, não notifica
                if oferta["preco"] == 0:
                    continue

                # Filtra preços acima do limite por grupo
                ...
                time.sleep(1)  # Evita erro 429 do Discord

            time.sleep(2)  # Delay entre rotas
